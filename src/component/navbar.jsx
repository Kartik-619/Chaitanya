    ...
    <>
      ...
      {menu && (
        <>
          ...
          {/* Sidebar Panel */}
          <div
            className="fixed top-0 right-0 h-full w-72 bg-stone-800 shadow-xl z-50 transform transition-transform duration-300"
            style={{ boxShadow: "0 0 30px rgba(0,0,0,0.3)" }}
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header */}
            <div className="p-5 border-b border-gray-200 flex justify-between items-center">
              <h3 className="trade-font text-4xl  font-bold text-gray-100">Menu</h3>
              <button
                onClick={() => setMenu(false)}
